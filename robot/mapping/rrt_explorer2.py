...
class RRTExplorer(Node):
    ...
    def __init__(
        ...
        self.get_logger().info("RRT frontier explorer initialized (my rrt / commit 9686606).")
    ...
    # ====================================================================
    # FOLLOWER  (two-phase: TURN in place, then DRIVE straight)
    # ====================================================================
    def follow_path(self) -> None:
        ...
        # Hysteresis: enter TURN at >90°, exit TURN at <6°.
        if self._turning:
    ...
    def get_map_snapshot(self) -> Optional[MapSnapshot]:
        ...
        grid[observed & (log_odds > 0.5)] = 100
